...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_seq_len', default=650, type=int, help="蒸馏的最大截断长度（中文1token≈1.5~1.7字符）")
    parser.add_argument('--use_moe', default=0, type=int, choices=[0, 1], help="是否使用MoE架构（0=否，1=是）")
    # parser.add_argument("--data_path", type=str, default="../dataset/sft_mini_512.jsonl", help="训练数据路径")
    parser.add_argument("--data_path", type=str, default="../dataset/sft_1024.jsonl", help="蒸馏数据路径")
